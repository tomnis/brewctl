...
# CORS configuration
BREWCTL_CORS_ORIGINS = os.environ.get('BREWCTL_CORS_ORIGINS', 'http://localhost:5173').split(',')

# API rate limiting
BREWCTL_API_RATE_LIMIT_ENABLED = os.environ.get('BREWCTL_API_RATE_LIMIT_ENABLED', 'true').lower() == 'true'
BREWCTL_API_RATE_LIMIT_REQUESTS = int(os.environ.get('BREWCTL_API_RATE_LIMIT_REQUESTS', '100'))
BREWCTL_API_RATE_LIMIT_WINDOW = int(os.environ.get('BREWCTL_API_RATE_LIMIT_WINDOW', '60'))

# Health check configuration
BREWCTL_HEALTH_CHECK_INTERVAL = float(os.environ.get('BREWCTL_HEALTH_CHECK_INTERVAL', '30.0'))

# Brew strategy configuration
BREWCTL_DEFAULT_STRATEGY = os.environ.get('BREWCTL_DEFAULT_STRATEGY', 'DEFAULT')
BREWCTL_STRATEGY_TIMEOUT = int(os.environ.get('BREWCTL_STRATEGY_TIMEOUT', '300'))  # 5 minutes

# Quality scoring configuration
BREWCTL_QUALITY_SCORING_ENABLED = os.environ.get('BREWCTL_QUALITY_SCORING_ENABLED', 'true').lower() == 'true'
BREWCTL_QUALITY_SCORING_WINDOW = int(os.environ.get('BREWCTL_QUALITY_SCORING_WINDOW', '60'))  # seconds