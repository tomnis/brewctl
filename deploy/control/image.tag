# The image brewctl runs on the control host. This file IS the deploy.
#
...
# image is still loaded on the control host, since there is no registry to re-pull from.
#
...
# catacombs/brewctl:sha-<short12> onto the control host for every build and prints the exact
